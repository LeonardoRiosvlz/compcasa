...
export type MedicalSpecialtiesFormField = {
    name: string;
    description?: string;
    isActive: boolean;
}
...
type MedicalSpecialtiesFormFiles = {
    //resolutionFile?: CloudFile,
    //programFile?: CloudFile
}

type Props = {
    submitAction: (data: MedicalSpecialtiesFormField) => unknown
    formId: string
    initialData?: MedicalSpecialtiesFormField
    initialFiles?: MedicalSpecialtiesFormFiles,
    upLoading?: () => void,
}
const MedicalSpecialtiesForm: React.FC<Props> = ({submitAction, initialFiles, upLoading, formId, initialData}: Props) => {
    ...
    const defaultValues: MedicalSpecialtiesFormField | {} = initialData ? {
        ...initialData
    } : {isActive: true};

    const {handleSubmit, control, formState: {errors, dirtyFields, isValid}} = useForm<MedicalSpecialtiesFormField>({
        mode: 'onChange',
        // @ts-ignore
    ...
    //const [files, setFiles] = React.useState<{ [K in keyof MedicalSpecialtiesFormFiles]?: File }>({});
    ...
    const onSubmit = (data: MedicalSpecialtiesFormField) => {
...
export default MedicalSpecialtiesForm;
