...
import { Headquarters } from 'api/repositories/headquarters/types/headquarters.types';



type Props = {
	row: Headquarters | null | undefined

}
const HeadquartersDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('HeadquartersconstantCase__INFO')}</h3>
